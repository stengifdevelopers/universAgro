        ...
        <form action="{{ route('findOffre') }}" method="POST">
            ...
            <div class="row d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="row">
                  <div class="col-md-8">
                        <input class="form-control form-control-md  mr-3 w-100 mt-2" type="text" name="titre" placeholder="Saisir un mot clé" aria-label="Search" style="border-color: darkorange; ">
                  </div>
                  <div class="col-md-4">
