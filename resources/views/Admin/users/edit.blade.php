          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Formulaire de modification d'un compte utilisateur</h1>
              </div>
              <div class="text-right">
                <a href="" class="btn btn-outline-warning btn-sm">
                    <i class="fas fa-key"></i> Edit Pswd
                </a>
                <a href="{{route('users.index')}}"><button class=" btn btn-sm btn-primary">Liste des utilisateurs</button></a>
              </div>
              <form class="user" action="{{route('users.update', $user)}}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
